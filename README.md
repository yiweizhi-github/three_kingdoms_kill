用lua语言基于面向对象思想实现的一款文字版三国杀，5000余行代码实现了三国杀标准版108张卡牌的效果以及标准包、风、林、火、山包中除神将和左慈外53位武将的技能效果。输入lua main.lua即可试玩。PS：由于工作量实在是太大，本项目的代码测试工作才刚开始，当前版本可能存在不少bug，敬请谅解！后续严谨的测试流程完成后将奉上正式版！
项目亮点：
